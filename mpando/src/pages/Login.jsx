        ...
        <div className="bg-[#111315] w-full md:w-5/12 p-10 flex flex-col justify-between text-white">
          <div>
            <div className="flex items-center gap-2 mb-12">
              <div className="w-8 h-8 bg-[#ffffff] rounded-lg flex items-center justify-center">
                <img className="text-black font-bold text-xl italic" src='/assets/mpando-logo.png' alt='logo'/>
              </div>
              <span className="text-xl font-semibold tracking-tight">Mpando</span>
            </div>
          ...
          <div className="hidden md:block">
            <div className="bg-[#1C1F21] p-4 rounded-2xl border border-gray-800">
              ...
              <p className="text-2xl font-bold">102 <span className="text-[#FF5C5C] text-xs font-normal">-9%</span></p>
            </div>
          </div>
        </div>
        <div className="w-full md:w-7/12 p-8 md:p-16 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              <input type="checkbox" id="remember" className="w-4 h-4 accent-[#d97707] cursor-pointer" />
